...
function card(a) {
return `    <a class="story-card" href="article.html?id=${encodeURIComponent(a.id)}">       <div class="image" ${
        a.image
...
? d.map(a => ` <div class="draft"> <span> <b>${esc(a.title)}</b><br> <small>
${esc(a.category)} · ${esc(a.date)} </small> </span>
